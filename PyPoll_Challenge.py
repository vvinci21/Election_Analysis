...
# Track the winning candidate, vote count and percentage and winning county and percentage
winning_candidate = ""
winning_count = 0
winning_county = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        # 6c: Calculate the percentage of votes for the county. Define county results
